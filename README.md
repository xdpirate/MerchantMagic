# MerchantMagic
MerchantMagic is an addon for World of Warcraft, currently only for Cataclysm (4.3.4) and Mists of Pandaria (5.4.8). 
...
| bindtype | = | A string defining a valid bind type:<br />Does not bind: "none"<br />Binds on Pickup: "bop"<br />Binds on Equip: "boe"<br />Binds on Use: "bou"<br />E.g.: ```bindtype=bop```, matches items that bind on pickup. |
